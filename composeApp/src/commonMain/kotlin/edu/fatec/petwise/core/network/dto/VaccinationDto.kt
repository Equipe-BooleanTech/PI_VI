...
fun Vaccination.toDto(): VaccinationDto = VaccinationDto(
    ...
    nextDoseDate = nextDoseDate?.toString(),
...
fun VaccinationDto.toDomain(): Vaccination = Vaccination(
    ...
    vaccinationDate = kotlinx.datetime.LocalDateTime.parse(vaccinationDate),
    nextDoseDate = nextDoseDate?.let { kotlinx.datetime.LocalDateTime.parse(it) },
    totalDoses = totalDoses,
    manufacturer = manufacturer,
    observations = observations,
