...
fun createEditToyFormConfiguration(toy: Toy): FormConfiguration = FormConfiguration(
    id = "edit_toy_form",
    title = "Editar Brinquedo - ${toy.name}",
    description = "Atualize as informações do brinquedo.",
    layout = FormLayout(
        columns = 1,
        maxWidth = 600,
        spacing = 16,
    ...
    fields = listOf(
        FormFieldDefinition(
            ...
            default = JsonPrimitive(toy.name),
            validators = listOf(
                ValidationRule(
        ...
        FormFieldDefinition(
            ...
            default = JsonPrimitive(toy.brand),
            validators = listOf(
                ValidationRule(
                    type = ValidationType.REQUIRED,
        ...
        FormFieldDefinition(
            ...
            default = JsonPrimitive(toy.category),
            validators = listOf(
                ValidationRule(
                    type = ValidationType.REQUIRED,
        ...
        FormFieldDefinition(
            ...
            default = JsonPrimitive(toy.description ?: ""),
        ...
        FormFieldDefinition(
            ...
            default = JsonPrimitive(toy.price.toString()),
            validators = listOf(
                ValidationRule(
                    type = ValidationType.REQUIRED,
        ...
        FormFieldDefinition(
            ...
            placeholder = "Ex: 50",
            default = JsonPrimitive(toy.stock.toString()),
            validators = listOf(
                ValidationRule(
                    type = ValidationType.REQUIRED,
        ...
        FormFieldDefinition(
            ...
            default = JsonPrimitive(toy.unit),
            validators = listOf(
                ValidationRule(
                    type = ValidationType.REQUIRED,
        ...
        FormFieldDefinition(
            ...
            default = JsonPrimitive(toy.material ?: ""),
            validators = emptyList(),
            formatting = FieldFormatting(capitalize = true)
        ),
        FormFieldDefinition(
            ...
            default = JsonPrimitive(toy.ageRecommendation ?: ""),
            validators = emptyList()
        ),
        FormFieldDefinition(
            id = "imageUrl",
            ...
            type = FormFieldType.TEXT,
            placeholder = "https://...",
            default = JsonPrimitive(toy.imageUrl ?: ""),
            validators = emptyList()
        ),
        FormFieldDefinition(
            id = "active",
            ...
            default = JsonPrimitive(toy.active),
            validators = emptyList()
        ),
        FormFieldDefinition(
            id = "submit",
