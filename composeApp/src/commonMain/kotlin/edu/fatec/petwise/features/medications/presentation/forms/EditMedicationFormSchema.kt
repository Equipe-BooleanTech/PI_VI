...
fun createEditMedicationFormConfiguration(medication: Medication): FormConfiguration = FormConfiguration(
    ...
    fields = listOf(
        ...
        FormFieldDefinition(
            ...
            type = FormFieldType.SELECT,
            options = emptyList(), // Will be populated dynamically
            default = JsonPrimitive(medication.veterinarianId),
            validators = listOf(
                ValidationRule(
                    type = ValidationType.REQUIRED,
        ...
        FormFieldDefinition(
            ...
            default = JsonPrimitive(medication.prescriptionId),
            validators = listOf(
                ValidationRule(
                    type = ValidationType.REQUIRED,
